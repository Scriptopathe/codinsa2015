...
namespace Clank.Core.Generation.Languages
{
    ...
    /// </summary>
    [LanguageGenerator("cppw")]
    public class CppGeneratorWin : ILanguageGenerator
    {
        ...
        public CppGeneratorWin(Clank.Core.Model.ProjectFile project)
        {
            SetProject(project);
        }
        /// <summary>
